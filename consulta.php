...
<html lang="en">
  <head>
    ...
    <title>Consulta emprendedores</title>
    <!-- Estilos CSS -->
  ...
  <body class="container">
    <div class="container w-100 my-4 p-2 justify-content-center align-items-center vstack gap-3">
      <h1>Lista de emprendedores registrados</h1>
      <!-- Mostrar mensaje de éxito o error si existe --> <?php
          if (isset($_SESSION['registro_exitoso'])) {
            echo "
											<div class='alert alert-success'>".$_SESSION['registro_exitoso']."</div>";
      ...
      <div class="row d-flex justify-content-around">
        ...
        <div class="col-6 col-lg-2 mb-3">
          <ul class="list-unstyled">
            ...
            <li class="mb-2">
              <a href="https://ruesfront.rues.org.co/">Validar empresa</a>
            </li>
            <li class="mb-2">
        ...
        <div class="col-12 col-lg-4 mb-3 d-flex flex-column align-items-center">
          <a class="col " href="consulta.php">
            <button class="rounded-2"> Consultar emprendedores </button>
          </a>
        </div>
      </div>
    </div>
