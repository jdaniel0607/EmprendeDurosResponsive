      ...
      <div class="collapse navbar-collapse align-items-end flex-column" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item button-header p-0 m-0">
            <a class="nav-link a-button-header" href="consulta.php" onclick="mostrarPopup()">Consultar emprendedores</a>
          </li>
        </ul>
      </div>
    </div>
...
<body class="container">
 <!--inicio dashboard -->
  ...
  <div class="my-4">
    <h2 class="mb-1">Información de usuario</h2>
    <hr class="dashed">
  ...
  <!-- Hasta aquí actualizar -->
  <div class="grid d-flex v-stack gap-2 justify-content-center">
    <form class="" method="POST">
      <button type="submit" name="logout" class="boton-cerrar-s">Cerrar sesión</button>
    </form>
    <a href="actualizar.php" class="boton-editar">Editar<i class="fa-regular fa-pen-to-square p-1" aria-hidden="true"></i></a>
  </div>
 <!--Fin dashboard -->
