...
<!--Inicio de actualizar-->
    ...
    <div class="container mt-4">
        <form id="formActualizarDatos" class="row g-3" method="POST">
            ...
            <div class="grid d-flex v-stack gap-2 justify-content-center mt-4">
                <a href="dashboard.php" class="boton-cerrar-s">Volver</a>
                <button type="submit" name="actualizar" class="boton-editar" id="btnActualizar">Actualizar Datos</button>
            </div>
        </form>
    </div>
<!--Fin de actualizar-->
